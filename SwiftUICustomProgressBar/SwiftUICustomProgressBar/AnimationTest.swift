...
//                    }
                ...
                ProgressBar(progressAmount: $progressAmount, progressPercentage: $progressPercentage, width:w, height: height, scale: scale, duration:duration, isRoundShape:false, onUpdate: { progress in
                    print("\(progress)")
                }, onComplete: {
